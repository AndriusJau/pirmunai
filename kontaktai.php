...
<body class="bodis">
	...
	<div class="container">
		...
		<p>
			P.Programuotojai Travel administruoja: <br>
			<br>UAB "P.Programuotojai Travel"<br>
			Įmonės kodas 302583106 <br>
			PVM mokėtojo kodas LT100005943011 <br>
			Adresas: Kęstučio g. 4, LT-21104 <br>
			Trakai, Lietuva <br> <br>

			Darbo laikas: <br>
			I-V 08:00-19:00 <br>
			VI–VII 09:00-17:00 (tik skambučiai) <br> <br>
			<i class="material-icons prefix">phone</i>
			<a href="tel:%2B370%20639%2096%20444">(8-655) 55 555</a><br>
			<i class="material-icons prefix">email</i>
			<a href="mailto:info@ptravel.lt">info@ptravel.lt</a><br>
		</p>
		...
		<p style="text-align: center;"><strong>Susisiekite asmeniškai:</strong></p>
		<div class="row">
			<div class="col s12 m6 l3">
				<img class="responsive-img circle" src="images/AndriusJ1.jpg">
				<p style="text-align: center;">Andrius Jauniškis</p>
				<p>
					<i class="material-icons prefix">phone</i>
					<a href="tel:%2B370%20639%2096%20444">(8-611) 11 111</a><br>
					<i class="material-icons prefix">email</i>
				...
				<div class="col s12 m6 l3">
					...
					<p>
						<i class="material-icons prefix">phone</i>
						<a href="tel:%2B370%20639%2096%20444">(8-622) 22 222 </a><br>
						<i class="material-icons prefix">email</i>
					...
					<div class="col s12 m6 l3">
						...
						<p>
							<i class="material-icons prefix">phone</i>
							<a href="tel:%2B370%20639%2096%20444">(8-633) 33 333 </a><br>
							<i class="material-icons prefix">email</i>
						...
						<div class="col s12 m6 l3">
							...
							<p>
								<i class="material-icons prefix">phone</i>
								<a href="tel:%2B370%20639%2096%20444">(8-644) 44 444</a><br> 
								<i class="material-icons prefix">email</i> 
							...
							<div class="zinute">
								<div class="col s12 m6 l6">
									...
									<form action="kur siuncia duomenis " class="left-align">
										...
										Pavardė:<br><input type="text" name="Pavarde" ><br>

										Jūsų el. pašto adresas:<br><input type="text" name="Elpaštas" ><br>

										<i class="material-icons prefix">mode_edit</i>
										Jūsų klausimas:<br>
										<textarea class="materialize-textarea" name="klausymo_tekstas"></textarea><br>
										<input type="submit" value="Siųsti"></form> 
									</div>
								</div>
							</div>
